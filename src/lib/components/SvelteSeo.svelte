...
<svelte:head>
    ...
    {#if noindex || nofollow}
        <meta
            name="robots"
            content="{noindex ? 'noindex' : ''}{noindex && nofollow
                ? ','
                : ''}{nofollow ? 'nofollow' : ''}"
        />
    {/if}
    ...
    <script type="text/javascript">
        atOptions = {
            key: "9d771f8efefff9be8cf726901a7cf6f8",
            format: "iframe",
            height: 600,
            width: 160,
            params: {},
    ...
    <script
        ...
        src="//www.highperformanceformat.com/9d771f8efefff9be8cf726901a7cf6f8/invoke.js"
    ></script>
</svelte:head>
